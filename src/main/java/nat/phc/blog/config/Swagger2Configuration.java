...
/**
 * @Author: PengHaiChen
 * @Description: 这是对于swqgger框架的配置
 * @Date: Create in 16:22 2020/7/21
 * http://localhost:2333/swagger-ui.html
 */
@Configuration
public class Swagger2Configuration {
    ...
    public Docket adminApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("nat.phc.blog.controller.admin"))
                .paths(PathSelectors.any()) // 可以根据url路径设置哪些请求加入文档，忽略哪些请求
                .build()
                .groupName("管理中心");
    }
    ...
    public Docket UserApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(userApiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("nat.phc.blog.controller.user"))
                .paths(PathSelectors.any()) // 可以根据url路径设置哪些请求加入文档，忽略哪些请求
                .build()
                .groupName("用户中心");
    }
